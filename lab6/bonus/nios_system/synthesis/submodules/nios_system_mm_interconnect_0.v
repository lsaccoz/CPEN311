...
module nios_system_mm_interconnect_0 (
		...
		output wire [1:0]  max_s1_address,                                   //                                     max_s1.address
		output wire        max_s1_write,                                     //                                           .write
		input  wire [31:0] max_s1_readdata,                                  //                                           .readdata
		output wire [31:0] max_s1_writedata,                                 //                                           .writedata
		output wire        max_s1_chipselect,                                //                                           .chipselect
	...
	wire   [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> switches_s1_agent:cp_channel
	...
	wire  [31:0] max_s1_agent_m0_readdata;                                                           // max_s1_translator:uav_readdata -> max_s1_agent:m0_readdata
	wire         max_s1_agent_m0_waitrequest;                                                        // max_s1_translator:uav_waitrequest -> max_s1_agent:m0_waitrequest
	wire         max_s1_agent_m0_debugaccess;                                                        // max_s1_agent:m0_debugaccess -> max_s1_translator:uav_debugaccess
	wire  [13:0] max_s1_agent_m0_address;                                                            // max_s1_agent:m0_address -> max_s1_translator:uav_address
	wire   [3:0] max_s1_agent_m0_byteenable;                                                         // max_s1_agent:m0_byteenable -> max_s1_translator:uav_byteenable
	wire         max_s1_agent_m0_read;                                                               // max_s1_agent:m0_read -> max_s1_translator:uav_read
	wire         max_s1_agent_m0_readdatavalid;                                                      // max_s1_translator:uav_readdatavalid -> max_s1_agent:m0_readdatavalid
	wire         max_s1_agent_m0_lock;                                                               // max_s1_agent:m0_lock -> max_s1_translator:uav_lock
	wire  [31:0] max_s1_agent_m0_writedata;                                                          // max_s1_agent:m0_writedata -> max_s1_translator:uav_writedata
	wire         max_s1_agent_m0_write;                                                              // max_s1_agent:m0_write -> max_s1_translator:uav_write
	wire   [2:0] max_s1_agent_m0_burstcount;                                                         // max_s1_agent:m0_burstcount -> max_s1_translator:uav_burstcount
	wire         max_s1_agent_rf_source_valid;                                                       // max_s1_agent:rf_source_valid -> max_s1_agent_rsp_fifo:in_valid
	wire  [92:0] max_s1_agent_rf_source_data;                                                        // max_s1_agent:rf_source_data -> max_s1_agent_rsp_fifo:in_data
	wire         max_s1_agent_rf_source_ready;                                                       // max_s1_agent_rsp_fifo:in_ready -> max_s1_agent:rf_source_ready
	wire         max_s1_agent_rf_source_startofpacket;                                               // max_s1_agent:rf_source_startofpacket -> max_s1_agent_rsp_fifo:in_startofpacket
	wire         max_s1_agent_rf_source_endofpacket;                                                 // max_s1_agent:rf_source_endofpacket -> max_s1_agent_rsp_fifo:in_endofpacket
	wire         max_s1_agent_rsp_fifo_out_valid;                                                    // max_s1_agent_rsp_fifo:out_valid -> max_s1_agent:rf_sink_valid
	wire  [92:0] max_s1_agent_rsp_fifo_out_data;                                                     // max_s1_agent_rsp_fifo:out_data -> max_s1_agent:rf_sink_data
	wire         max_s1_agent_rsp_fifo_out_ready;                                                    // max_s1_agent:rf_sink_ready -> max_s1_agent_rsp_fifo:out_ready
	wire         max_s1_agent_rsp_fifo_out_startofpacket;                                            // max_s1_agent_rsp_fifo:out_startofpacket -> max_s1_agent:rf_sink_startofpacket
	wire         max_s1_agent_rsp_fifo_out_endofpacket;                                              // max_s1_agent_rsp_fifo:out_endofpacket -> max_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> max_s1_agent:cp_valid
	wire  [91:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> max_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // max_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> max_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> max_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> max_s1_agent:cp_endofpacket
	...
	wire  [13:0] sum_s1_agent_m0_address;                                                            // sum_s1_agent:m0_address -> sum_s1_translator:uav_address
	...
	wire  [92:0] sum_s1_agent_rf_source_data;                                                        // sum_s1_agent:rf_source_data -> sum_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] sum_s1_agent_rsp_fifo_out_data;                                                     // sum_s1_agent_rsp_fifo:out_data -> sum_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> sum_s1_agent:cp_valid
	wire  [91:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> sum_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // sum_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> sum_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> sum_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> sum_s1_agent:cp_endofpacket
	...
	wire  [92:0] start_s1_agent_rf_source_data;                                                      // start_s1_agent:rf_source_data -> start_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] start_s1_agent_rsp_fifo_out_data;                                                   // start_s1_agent_rsp_fifo:out_data -> start_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> start_s1_agent:cp_valid
	wire  [91:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> start_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // start_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> start_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> start_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> start_s1_agent:cp_endofpacket
	...
	wire  [13:0] done_s1_agent_m0_address;                                                           // done_s1_agent:m0_address -> done_s1_translator:uav_address
	...
	wire  [92:0] done_s1_agent_rf_source_data;                                                       // done_s1_agent:rf_source_data -> done_s1_agent_rsp_fifo:in_data
	...
	wire  [92:0] done_s1_agent_rsp_fifo_out_data;                                                    // done_s1_agent_rsp_fifo:out_data -> done_s1_agent:rf_sink_data
	...
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> done_s1_agent:cp_valid
	wire  [91:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> done_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // done_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> done_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> done_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> done_s1_agent:cp_endofpacket
	...
	wire         max_s1_agent_rp_valid;                                                              // max_s1_agent:rp_valid -> router_007:sink_valid
	wire  [91:0] max_s1_agent_rp_data;                                                               // max_s1_agent:rp_data -> router_007:sink_data
	wire         max_s1_agent_rp_ready;                                                              // router_007:sink_ready -> max_s1_agent:rp_ready
	wire         max_s1_agent_rp_startofpacket;                                                      // max_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         max_s1_agent_rp_endofpacket;                                                        // max_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         sum_s1_agent_rp_valid;                                                              // sum_s1_agent:rp_valid -> router_008:sink_valid
	wire  [91:0] sum_s1_agent_rp_data;                                                               // sum_s1_agent:rp_data -> router_008:sink_data
	wire         sum_s1_agent_rp_ready;                                                              // router_008:sink_ready -> sum_s1_agent:rp_ready
	wire         sum_s1_agent_rp_startofpacket;                                                      // sum_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         sum_s1_agent_rp_endofpacket;                                                        // sum_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         start_s1_agent_rp_valid;                                                            // start_s1_agent:rp_valid -> router_009:sink_valid
	wire  [91:0] start_s1_agent_rp_data;                                                             // start_s1_agent:rp_data -> router_009:sink_data
	wire         start_s1_agent_rp_ready;                                                            // router_009:sink_ready -> start_s1_agent:rp_ready
	wire         start_s1_agent_rp_startofpacket;                                                    // start_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         start_s1_agent_rp_endofpacket;                                                      // start_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         done_s1_agent_rp_valid;                                                             // done_s1_agent:rp_valid -> router_010:sink_valid
	wire  [91:0] done_s1_agent_rp_data;                                                              // done_s1_agent:rp_data -> router_010:sink_data
	wire         done_s1_agent_rp_ready;                                                             // router_010:sink_ready -> done_s1_agent:rp_ready
	wire         done_s1_agent_rp_startofpacket;                                                     // done_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         done_s1_agent_rp_endofpacket;                                                       // done_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         max_s1_agent_rdata_fifo_src_valid;                                                  // max_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] max_s1_agent_rdata_fifo_src_data;                                                   // max_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         max_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_005:in_0_ready -> max_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> max_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> max_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // max_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> max_s1_agent:rdata_fifo_sink_error
	wire         sum_s1_agent_rdata_fifo_src_valid;                                                  // sum_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] sum_s1_agent_rdata_fifo_src_data;                                                   // sum_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         sum_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_006:in_0_ready -> sum_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> sum_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> sum_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // sum_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> sum_s1_agent:rdata_fifo_sink_error
	wire         start_s1_agent_rdata_fifo_src_valid;                                                // start_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] start_s1_agent_rdata_fifo_src_data;                                                 // start_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         start_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_007:in_0_ready -> start_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> start_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> start_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // start_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> start_s1_agent:rdata_fifo_sink_error
	wire         done_s1_agent_rdata_fifo_src_valid;                                                 // done_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] done_s1_agent_rdata_fifo_src_data;                                                  // done_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         done_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_008:in_0_ready -> done_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> done_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> done_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                  // done_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> done_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (max_s1_agent_m0_address),                          // avalon_universal_slave_0.address
		.uav_burstcount         (max_s1_agent_m0_burstcount),                       //                         .burstcount
		.uav_read               (max_s1_agent_m0_read),                             //                         .read
		.uav_write              (max_s1_agent_m0_write),                            //                         .write
		.uav_waitrequest        (max_s1_agent_m0_waitrequest),                      //                         .waitrequest
		.uav_readdatavalid      (max_s1_agent_m0_readdatavalid),                    //                         .readdatavalid
		.uav_byteenable         (max_s1_agent_m0_byteenable),                       //                         .byteenable
		.uav_readdata           (max_s1_agent_m0_readdata),                         //                         .readdata
		.uav_writedata          (max_s1_agent_m0_writedata),                        //                         .writedata
		.uav_lock               (max_s1_agent_m0_lock),                             //                         .lock
		.uav_debugaccess        (max_s1_agent_m0_debugaccess),                      //                         .debugaccess
		.av_address             (max_s1_address),                                   //      avalon_anti_slave_0.address
		.av_write               (max_s1_write),                                     //                         .write
		.av_readdata            (max_s1_readdata),                                  //                         .readdata
		.av_writedata           (max_s1_writedata),                                 //                         .writedata
		.av_chipselect          (max_s1_chipselect),                                //                         .chipselect
		.av_read                (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
		.av_beginbursttransfer  (),                                                 //              (terminated)
		.av_burstcount          (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (max_s1_agent_m0_address),                          //              m0.address
		.m0_burstcount           (max_s1_agent_m0_burstcount),                       //                .burstcount
		.m0_byteenable           (max_s1_agent_m0_byteenable),                       //                .byteenable
		.m0_debugaccess          (max_s1_agent_m0_debugaccess),                      //                .debugaccess
		.m0_lock                 (max_s1_agent_m0_lock),                             //                .lock
		.m0_readdata             (max_s1_agent_m0_readdata),                         //                .readdata
		.m0_readdatavalid        (max_s1_agent_m0_readdatavalid),                    //                .readdatavalid
		.m0_read                 (max_s1_agent_m0_read),                             //                .read
		.m0_waitrequest          (max_s1_agent_m0_waitrequest),                      //                .waitrequest
		.m0_writedata            (max_s1_agent_m0_writedata),                        //                .writedata
		.m0_write                (max_s1_agent_m0_write),                            //                .write
		.rp_endofpacket          (max_s1_agent_rp_endofpacket),                      //              rp.endofpacket
		.rp_ready                (max_s1_agent_rp_ready),                            //                .ready
		.rp_valid                (max_s1_agent_rp_valid),                            //                .valid
		.rp_data                 (max_s1_agent_rp_data),                             //                .data
		.rp_startofpacket        (max_s1_agent_rp_startofpacket),                    //                .startofpacket
		...
		.rf_sink_ready           (max_s1_agent_rsp_fifo_out_ready),                  //         rf_sink.ready
		.rf_sink_valid           (max_s1_agent_rsp_fifo_out_valid),                  //                .valid
		.rf_sink_startofpacket   (max_s1_agent_rsp_fifo_out_startofpacket),          //                .startofpacket
		.rf_sink_endofpacket     (max_s1_agent_rsp_fifo_out_endofpacket),            //                .endofpacket
		.rf_sink_data            (max_s1_agent_rsp_fifo_out_data),                   //                .data
		.rf_source_ready         (max_s1_agent_rf_source_ready),                     //       rf_source.ready
		.rf_source_valid         (max_s1_agent_rf_source_valid),                     //                .valid
		.rf_source_startofpacket (max_s1_agent_rf_source_startofpacket),             //                .startofpacket
		.rf_source_endofpacket   (max_s1_agent_rf_source_endofpacket),               //                .endofpacket
		.rf_source_data          (max_s1_agent_rf_source_data),                      //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                //                .error
		.rdata_fifo_src_ready    (max_s1_agent_rdata_fifo_src_ready),                //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (max_s1_agent_rdata_fifo_src_valid),                //                .valid
		.rdata_fifo_src_data     (max_s1_agent_rdata_fifo_src_data),                 //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) max_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (max_s1_agent_rf_source_data),                      //        in.data
		.in_valid          (max_s1_agent_rf_source_valid),                     //          .valid
		.in_ready          (max_s1_agent_rf_source_ready),                     //          .ready
		.in_startofpacket  (max_s1_agent_rf_source_startofpacket),             //          .startofpacket
		.in_endofpacket    (max_s1_agent_rf_source_endofpacket),               //          .endofpacket
		.out_data          (max_s1_agent_rsp_fifo_out_data),                   //       out.data
		.out_valid         (max_s1_agent_rsp_fifo_out_valid),                  //          .valid
		.out_ready         (max_s1_agent_rsp_fifo_out_ready),                  //          .ready
		.out_startofpacket (max_s1_agent_rsp_fifo_out_startofpacket),          //          .startofpacket
		.out_endofpacket   (max_s1_agent_rsp_fifo_out_endofpacket),            //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	nios_system_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (max_s1_agent_rp_ready),                            //      sink.ready
		.sink_valid         (max_s1_agent_rp_valid),                            //          .valid
		.sink_data          (max_s1_agent_rp_data),                             //          .data
		.sink_startofpacket (max_s1_agent_rp_startofpacket),                    //          .startofpacket
		.sink_endofpacket   (max_s1_agent_rp_endofpacket),                      //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (max_s1_agent_rdata_fifo_src_data),                 //     in_0.data
		.in_0_valid     (max_s1_agent_rdata_fifo_src_valid),                //         .valid
		.in_0_ready     (max_s1_agent_rdata_fifo_src_ready),                //         .ready
