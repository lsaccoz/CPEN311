...
typedef enum int unsigned {INIT = 1 , START = 2, 
              ...
              ERASE_PADDLE_A_ENTER = 512, ERASE_PADDLE_A_LOOP = 1024, 
              DRAW_PADDLE_A_ENTER = 2048, DRAW_PADDLE_A_LOOP = 4096, 
			  ERASE_PADDLE_B_ENTER = 513, ERASE_PADDLE_B_LOOP = 1025, 
              DRAW_PADDLE_B_ENTER = 2049, DRAW_PADDLE_B_LOOP = 4097, 
...
parameter PADDLE_ROW_A = 4;  // row to draw the paddle 
